...
This course introduces the most basic and important data structures and algorithms in computer programming through Python language. The main contents include Python language basic introduction, object-oriented programming, algorithm complexity analysis, common data structure and Python implementation of algorithms.
...
5. [Array-based sequence](https://github.com/shaqsnake/Data-Structures-and-Algorithms-in-Python/blob/master/05-Array-Based-Sequences.ipynb)
6. [Stack and queue](https://github.com/shaqsnake/Data-Structures-and-Algorithms-in-Python/blob/master/06-Stacks-and-Queues.ipynb)
7. [Linked list](https://github.com/shaqsnake/Data-Structures-and-Algorithms-in-Python/blob/master/07-Linked-Lists.ipynb)
8. [Hash tables and collection](https://github.com/shaqsnake/Data-Structures-and-Algorithms-in-Python/blob/master/08-Hash-Tables-and-Sets.ipynb)
9. [Sorting Algorithm](https://github.com/shaqsnake/Data-Structures-and-Algorithms-in-Python/blob/master/09-Sorting-Algorithms.ipynb)
10. [tree](https://github.com/shaqsnake/Data-Structures-and-Algorithms-in-Python/blob/master/10-Trees.ipynb)
